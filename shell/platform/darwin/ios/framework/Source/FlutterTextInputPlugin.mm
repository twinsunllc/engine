...
- (void)setSizeAndTransform:(NSDictionary*)sizeAndTransform {
  ...
  _activeView.frame = CGRectMake(
      [sizeAndTransform[@"transform"][12] intValue], [sizeAndTransform[@"transform"][13] intValue],
      [sizeAndTransform[@"width"] intValue], [sizeAndTransform[@"height"] intValue]);
}
